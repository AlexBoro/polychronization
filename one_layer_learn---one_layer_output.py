...
out_params_izk_out = {'a': izk_types[out_cell_type]['a'],
                      ...
                      'v_init': izk_types[out_cell_type]['c'],
                      'u_init': izk_types[out_cell_type]['b']*izk_types[out_cell_type]['c'],
...
cell_params_izk_exc = {'a': izk_types[exc_cell_type]['a'],
                       ...
                       'v_init': izk_types[exc_cell_type]['c'],
                       'u_init': izk_types[exc_cell_type]['b']*izk_types[exc_cell_type]['c'],
...
cell_params_izk_inh = {'a': izk_types[inh_cell_type]['a'],
                       ...
                       'v_init': izk_types[inh_cell_type]['c'],
                       'u_init': izk_types[inh_cell_type]['b']*izk_types[inh_cell_type]['b'],
...
cell_params_izk_inv = {'a': izk_types[inv_cell_type]['a'],
                       ...
                       'v_init': izk_types[inv_cell_type]['c'],
                       'u_init': izk_types[inv_cell_type]['b']*izk_types[inv_cell_type]['c'],
