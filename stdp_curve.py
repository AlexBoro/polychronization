...
for t in delta_t:
    ...
    ee_connector = sim.OneToOneConnector(weights=weight_to_spike)
    ...
    stdp_model = sim.STDPMechanism(
        timing_dependence = sim.SpikePairRule(tau_plus=tau_plus, tau_minus=tau_minus, nearest=True),
        weight_dependence = sim.AdditiveWeightDependence(w_min=w_min, w_max=w_max, A_plus=A_plus, A_minus=A_minus),
        mad=mad
    )
